...
Keep track of all the problems you solve here. Review this list before interviews.
...
| Name | Type | Notes |
| :--- | :--- | :--- |
| **DSU (Disjoint Set Union)** | Template | Path compression & union by rank |
| **Segment Tree** | Template | Range Sum/Min/Max queries in `O(log N)` |
| **Trie (Prefix Tree)** | Template | `insert`, `search`, `startsWith` in `O(L)` |
| **Singly LinkedList** | Custom Container | Full append, prepend, insert, remove, reverse |
